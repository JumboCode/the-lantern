    ...
    <h1 className="mt-20 font-coolvetica text-7xl ml-12">Get in touch!</h1>
        ...
        <form onSubmit={onSubmit}>
            <div className="flex flex-col border-contact-g1 border-4 mx-16 mb-16 mt-10 px-7 h-contact bg-gradient-to-b from-contact-g1 to-contact-g2 rounded-3xl">
                ...
                <div>
                    <h2 className="mt-5 text-nunito text-lg">Message</h2>
                    <input type="text" name="message" className="mt-2 w-full p-3  border-contact-g1 border-4 mr-7 contact-input-height rounded-3xl"></input>
                    <br></br>
                </div>

                <div className="flex justify-center items-center">
                    <button type="submit" className="bg-button-blue border-button-outline-blue border-2 mt-9 text-white font-bold py-2 px-10 mb-8 rounded-3xl">Submit</button> 
                </div>
            </div>
        </form>
        </div>
