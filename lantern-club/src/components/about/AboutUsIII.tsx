...
export default function AboutUsIII() {
  ...
  return (
    <div>
      <div className="-mt-20 py-40 px-20 orange-gradient" style={background}> 
        <p style={header_font}>What is STS?</p>
        <div className="pale-yellow mellow-yellow-border" style={round_box}>
          <div className="w-1/2 py-5 font-nunito text-2xl flex ml-4"><p>Science, Technology & Society (STS) is an interdisciplinary field of study that seeks to explore and understand the many ways that modern science and technology shape modern culture, values, and institutions, and how modern values shape science and technology. STS examines how science and technology emerge, how they enter society, how they change through social processes, and how society changes in response to science and technology. (<a href="https://majorsandminors.dasa.ncsu.edu/science-technology-society/#:~:text=Science%2C%20Technology%20%26%20Society%20(STS,values%20shape%20science%20and%20technology." className="text-sky-500 underline">NC State University.</a>)</p></div>
