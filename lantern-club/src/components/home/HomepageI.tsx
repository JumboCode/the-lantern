...
export default function HomepageI({title}:{title:string}){
    ...
    return(
        <div>
            <div className="flex h-13 bg-gradient-to-r from-gc1 via-gc2 via-gc3 via-gc4 to-gc5 grid grid-rows-3">
            ...
            <div className="h-20 w-full bg-gradient-to-r from-gc1 via-gc2 via-gc3 via-gc4 to-gc5" id="triangle"></div>
        </div>
     )
}