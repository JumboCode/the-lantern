    ...
    return(
        <div className="drop-shadow-md">
            <div className="flex h-13 bg-center bg-cover bg-no-repeat bg-[url('../images/background.png')] grid grid-rows-3">
                    ...
                    <h1 className="justify-self-end mr-20 mt-40 text-2xl md:text-4xl font-nunitolight text-center tracking-wide">A think-tank advocating socially responsible
                    <br></br> technology use and production</h1>
                    <img src={logo.src} height={200} width={200} className="flex inline-flex rotate-6 opacity-40 self-end overflow-x-hidden"/>
            </div>            
