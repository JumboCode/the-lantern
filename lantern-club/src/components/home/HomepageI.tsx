        ...
        <div className="drop-shadow-md">
                ...
                <div className="flex justify-center align-center bg-center bg-cover bg-no-repeat bg-[url('/images/background.png')] relative" id="header-pent">
                    <div className='mx-5 flex flex-col col-1 '>
                      ...
                      <h1 className="justify-self-center my-12 text-2xl pt-5 pb-12 md:pb-20 md:text-4xl font-nunitolight italic text-center tracking-wide">A think-tank advocating for socially responsible
