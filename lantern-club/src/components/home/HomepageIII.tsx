...
export default function HomepageIII() {
    ...
    return (
        <div>
            ...
            <div className="orange-gradient -mt-36 md:-mt-28 pt-40 pb-40 md:pt-20 md:pb-32 w-full flex flex-col md:grid md:grid-cols-2 md:gap-4 md:p-20 justify-center items-center"  id="pentagon-body">
                {/* text side */}
