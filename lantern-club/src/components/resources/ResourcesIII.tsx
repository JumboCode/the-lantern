...
export default function HomepageIII() {
    ...
    return (
        <div>
            <div className="-mt-96 md:-mt-52 w-full py-40 px-4 md:px-10 blue2-gradient" id="pentagon2">
                {/* text side */}
                <div className="py-8 px-4 md:px-0 pb-14 md:ml-10">
                    <p className="pt-52 md:pt-20 pb-5 md:text-7xl text-6xl font-coolvetica">
                ...
                <div className="flex-col pale-yellow mellow-yellow-border font-nunito text-xl ml-0 md:ml-10" style={round_box}>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center">
                        ...
                        <div className="relative md:w-1/2  md:h-auto flex justify-center">
                            <Image
                    ...
                    <div className="flex flex-col-reverse md:flex-row items-center justify-center">
                        <div className="relative w-full md:w-1/2  md:h-auto flex justify-center">
                            <Image
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center">
                        ...
                        <div className="relative w-full md:w-1/2 md:h-auto flex justify-center pt-10">
                            <Image
