...
export default function HomepageIII() {
    ...
    return (
        <div>
            <div className="-mt-20 py-20 px-10 blue2-gradient">
                {/* text side */}
                <div className="py-10 px-4 md:px-0 pb-14">
                    <p className="md:text-8xl text-6xl font-coolvetica">
                ...
                <div className="flex-col pale-yellow mellow-yellow-border font-nunito text-xl" style={round_box}>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center">
                        <div className="pr-10 w-full md:w-1/2 text-lg md:text-xl"> {/* Decreased right padding */}
                    ...
                    {/* Row 3 */}
                    <div className="flex flex-col md:flex-row items-center justify-center px-5">
                        <div className="md:pr-10 py-5 md:w-1/2"> {/* Decreased right padding */}
                            <p>
