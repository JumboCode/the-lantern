...
import DeleteModal from "@/components/magazine/DeleteModal";
                          ...
                          {showDeleteModal && (
                            <div style={{ zIndex: 999, position: "relative" }}>
                              <DeleteModal
                                ...
                                handleConfirm={() => { FileDelete(keyName) }}
